...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required usage by Zep SDK, warnings come from dynamic class creation, safe to ignore
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing nodes and edges, including time info, attributes, and other details
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
...
Return a JSON array of {k} strings. Do not include any other text."""
    ...
    def fetch_and_add_news(self, graph_id: str, query: str, limit: int = 5, context_text: Optional[str] = None) -> Optional[str]:
        """
        Fetch live news and add to graph as initial seed
        """
        try:
