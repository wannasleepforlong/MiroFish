...
class SimulationRunner:
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this env var won't exist, but cleanup should still be registered
    ...
    def check_env_alive(cls, simulation_id: str) -> bool:
        """
        Check whether simulation environment is alive (can receive Interview commands)
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: In dual-platform simulation, interview both platforms simultaneously, return integrated result
    ...
    def interview_agents_batch(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                ...
                - None: In dual-platform simulation, each Agent interviewed on both platforms simultaneously
            timeout: Timeout in seconds
    ...
    def close_simulation_env(
        ...
        Sends close environment command to simulation, causing it to exit gracefully from command-waiting mode
